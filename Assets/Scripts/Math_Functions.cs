...
namespace BLINDED_AM_ME
{
    ...
    public class Math_Functions
    {
        ...
        ///将范围内的值转换为另一个范围。 5在0到10之间等价于0.5在0和1之间
        /// </summary>
        /// <returns>.</returns>
        ...
        ///沿着给定的轴旋转，点（0,0,0）周围的向量点或方向。
        ///围绕vector的axis方向，旋转该变换 angleDegrees 度。 
        ///类似：Transform.RotateAround ------围绕世界坐标的point点的axis旋转该变换angle度。 
        /// </summary>
        /// <returns>.</returns>
        ...
        public static Vector3 Rotate_Vector(Vector3 vector, Vector3 axis, float angleDegrees)
        {
            ...
            // Rodrigues' rotation formula uses radians罗德里格斯的旋转公式使用弧度
        ...
        // 根据传入的四个点，插值t计算在p1,p2之间，Q(t)=0.5*[1 t t^2 t^3]
        public static Vector3 CatmullRom(Vector3 p0, Vector3 p1, Vector3 p2, Vector3 p3, float i)
        {
            // from Standard Assets
            // comments are no use here... it's the catmull-rom equation.这是catmull-rom方程式。
            // Un-magic this, lord vector!
            // centripetal Catmull-Rom spline, the value of α alpha is 0.5 . 
            return 0.5f * ((2f * p1) + (-p0 + p2) * i + (2f * p0 - 5f * p1 + 4f * p2 - p3) * i * i + (-p0 + 3f * p1 - 3f * p2 + p3) * i * i * i);
        }

        #endregion

        #region Trajectory//区域 轨迹

        // https://en.wikipedia.org/wiki/Trajectory_of_a_projectile射弹轨迹，只得是物体被抛出，考虑重力和阻力的影响，物体的轨迹

        /// <summary>
        /// if returns false, increase initSpeed如果返回false，增加init Speed
        /// </summary>
        ...
        /// <summary>
        /// returns the higher angle返回较高的角度
        /// </summary>
        ...
        /// <summary>
        /// returns the lower angle返回较低的角度
        /// </summary>
        ...
        /// <summary>
        /// angle needed to reach horizontal distance达到水平距离所需的角度
        /// </summary>
